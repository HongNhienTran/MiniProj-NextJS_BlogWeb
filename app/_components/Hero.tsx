    ...
    return (
        <section className="max-w-5xl mx-auto px-6 pt-12 pb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center items-center">
                <div className="relative w-full max-w-sm aspect-square bg-gradient-to-tr from-blue-50 to-blue-100/50 rounded-full flex items-center justify-center">
                    <div className="select-none filter drop-shadow-xl">
                        <img src="/Hero_IMG.png" alt="Hero Illustration" className="w-full h-full object-contain" />
                    </div>
                </div>
            </div>
        </section>
